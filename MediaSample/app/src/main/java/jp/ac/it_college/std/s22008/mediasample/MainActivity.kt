package jp.ac.it_college.std.s22008.mediasample
...
import jp.ac.it_college.std.s22008.mediasample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.swLoop.setOnCheckedChangeListener(::onLoopSwichChanged)
    }
    ...
    private fun mediaPlayerOnComletion(mediaPlayer: MediaPlayer) {
    ...
    private fun onLoopSwichChanged(buttonview: CompoundButton, isChecked: Boolean){
